                        ...
                        <tbody>
                            @forelse ($students as $student)
                                <tr>
                                    ...
                                    <td>{{ $student->classroom->name ?? '-' }} ({{ $student->classroom->year ?? '-' }})
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <!-- TROCAR TURMA -->
                                        <form action="{{ route('students.changeClassroom') }}" method="POST"
                                            class="d-flex align-items-center gap-1">
                                            @csrf

                                            <input type="hidden" name="student_id" value="{{ $student->id }}">

                                            <select name="classroom_id" class="form-select form-select-sm d-inline "
                                                style="max-width: 160px;">
                                                {{-- @foreach ($classrooms as $classroom)
                                                    <option value="{{ $classroom->id }}"
                                                        title="{{ $classroom->name }} ({{ $classroom->year }})"
